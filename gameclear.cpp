...
void GameClear::Init()
{
	AddGameObject<Title_Camera>(Draw_Camera)->_TransForm->_Position = { 0.0f,5.0f, -10.0f };
	AddGameObject<Title_SkyDome>(Draw_SkyDome);
	AddGameObject<Result_Clear>(Draw_Polygon2D)->SetSize({ SCREEN_WIDTH * 0.5f,SCREEN_HEIGHT * 0.2f,0.0f }, { SCREEN_WIDTH * 0.5f,SCREEN_HEIGHT * 0.2f,0.0f }, 0);
