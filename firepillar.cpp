...
void FirePillar::Init()
{
	...
	//Manager::GetScene()->AddGameObject_T<BlueFire_BillBoard>(Draw_Effect)->SetBillBoard({ _TransForm->_Position.x,_TransForm->_Position.y + _TransForm->_Scale.y * 0.5f,_TransForm->_Position.z }, _TransForm->_Scale);
}
